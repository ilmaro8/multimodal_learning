...
if (AGGREGATION_mode is AGGREGATION.normal and PERCENTAGE == -1):
	filename_output = retrieval_path + 'precision_at_'+str(at_k)+'_'+DATASET+'_'+type_data+'.csv'

elif (AGGREGATION_mode is AGGREGATION.normal and at_k == -1):
	filename_output = retrieval_path + 'precision_percentage_'+str(PERCENTAGE)+'_'+DATASET+'_'+type_data+'.csv'

elif (AGGREGATION_mode is AGGREGATION.micro and PERCENTAGE == -1):
	filename_output = retrieval_path + 'precision_micro_at_'+str(at_k)+'_'+DATASET+'_'+type_data+'.csv'

elif (AGGREGATION_mode is AGGREGATION.micro and at_k == -1):
	filename_output = retrieval_path + 'precision_micro_percentage_'+str(PERCENTAGE)+'_'+DATASET+'_'+type_data+'.csv'
